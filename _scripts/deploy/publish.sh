...
REGISTRY_AUTHENTICATION=aws ecr get-login-password --region us-west-2 | docker login --username AWS --password-stdin 832297766686.dkr.ecr.us-west-2.amazonaws.com
