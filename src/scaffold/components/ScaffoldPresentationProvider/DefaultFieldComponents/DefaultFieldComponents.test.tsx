...
describe("scaffold/components/ScaffoldPresentationProvider/DefaultFieldComponents", () => {
  describe("String", () => {
    it("works", async () => {
      ...
      const { container } = render(
        <String value="some string" onUpdate={callbackFn} />,
      );
  ...
  describe("Number", () => {
    it("formats numbers for us", async () => {
      const callbackFn = jest.fn();
      const { container } = render(<Number value={5} onUpdate={callbackFn} />);
      const input = container.querySelector("input");
  ...
  describe("Boolean", () => {
    it("works", async () => {
      const callbackFn = jest.fn();
      const { container } = render(
        <Boolean value={false} onUpdate={callbackFn} />,
      );
      const input = container.querySelector("input");
  ...
  describe("Date", () => {
    it("formats date for us", async () => {
      const callbackFn = jest.fn();
      const { container } = render(
        <Date value="2023-03-08" onUpdate={callbackFn} />,
      );
      const input = container.querySelector("input");
