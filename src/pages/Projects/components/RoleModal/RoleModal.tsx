            ...
            <HStack spacing="8px" width="100%">
              ...
              >
                ...
                <Input
                  ...
                  id="start_date"
                  focusBorderColor={
                    errors.start_date ? "red.600" : "currentColor"
                  }
                  type="date"
                  ...
                  title="StartDate"
                  mb={
                    errors?.start_confidence && !errors.start_date
                      ? "40px"
                      : errors?.start_confidence && errors.start_date
                      ? "0px"
                      : !errors?.start_confidence && errors.start_date
              ...
              >
                ...
                <Select
                  mb={
                    errors?.start_date && errors?.start_confidence
                      ? "0px"
                      : !errors?.start_date && errors?.start_confidence
                      ? "21px"
                      : "29px"
                ...
                >
                  ...
                  {Array.from(Array(21).keys()).map((n) => {
                    return (
                      <option value={`${n * 5}%`} key={n}>{`${n * 5}%`}</option>
                    );
                  })}
                </Select>
                <FormErrorMessage fontSize="12px">
                  {errors?.start_confidence?.message}
                </FormErrorMessage>
              </FormControl>
              ...
              <FormControl>
                ...
                >
                  <FolderIcon
                    ...
                    height="64px"
                  />
                  <Text w="370px" pt="40px" ml="6px" fontSize="14px">
